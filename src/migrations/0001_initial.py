    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.PositiveIntegerField(primary_key=True, serialize=False, verbose_name='RK ident')),
                ('code', models.PositiveSmallIntegerField(unique=True, verbose_name='RK Код')),
                ('legal_entity', models.CharField(blank=True, max_length=100, null=True, verbose_name='Юр лицо')),
                ('address', models.CharField(max_length=100, verbose_name='Адрес')),
                ('phone', models.CharField(blank=True, db_index=True, max_length=150, null=True, verbose_name='Номер телефона ресторана')),
                ('server_ip', models.GenericIPAddressField(blank=True, null=True, verbose_name='IP главного сервера RK')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tcp', models.PositiveSmallIntegerField(default=3029, verbose_name='TCP port')),
                ('web_server', models.PositiveSmallIntegerField(default=9000, verbose_name='Порт веб сервера')),
                ('is_sync', models.BooleanField(default=False, verbose_name='Синхронизация?')),
                ('is_active', models.BooleanField(default=True, verbose_name='Рабочий?')),
                ('franchise_owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='servers', to='src.franchiseowner', verbose_name='Франшиза')),
                ('restaurant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='servers', to='src.restaurant')),
